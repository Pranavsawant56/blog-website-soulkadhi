    ...
    <section className="max-w-6xl m-auto justify-center  pt-6 px-4">
      ...
      ">
        ...
        <Link
          ...
          target="_blank"
          className="col-span-2 sm:col-span-3 lg:col-span-4 lg:row-span-3 relative border border-black overflow-hidden group rounded-lg"
        >
        ...
        <Link
          ...
          target="_blank"
          className="col-span-1 relative border border-black overflow-hidden group rounded-lg"
        > 
        ...
        <Link
          ...
          target="_blank"
          className="col-span-2 sm:col-span-2 lg:col-span-2 lg:row-span-2 relative border border-black overflow-hidden group rounded-lg"
        >
        ...
        <Link
          ...
          target="_blank"
          className="col-span-2 sm:col-span-2 lg:col-span-2 lg:row-span-3 relative border border-black overflow-hidden group rounded-lg"
        >
        ...
        <Link
          href="https://www.instagram.com/p/DPtv8y9DEd8/?img_index=1"
          target="_blank"
          className="col-span-2 sm:col-span-3 lg:col-span-2 lg:row-span-3 relative border border-black overflow-hidden group rounded-lg"
        >
        ...
        <Link
          href="https://www.instagram.com/p/DQtYdk3jcM0/?img_index=1"
          target="_blank"
          className="col-span-2 sm:col-span-3 lg:col-span-2 lg:row-span-2 relative border border-black overflow-hidden group rounded-lg"
        >
        ...
        <Link
          href="https://www.instagram.com/p/DQtYdk3jcM0/?img_index=1"
          target="_blank"
          className="col-span-2 sm:col-span-6 lg:col-span-4 lg:row-span-2 relative border border-black overflow-hidden group rounded-lg"
        >
